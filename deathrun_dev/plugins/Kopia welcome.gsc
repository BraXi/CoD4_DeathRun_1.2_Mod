...
init( modVersion )
{
	braxi\_dvar::addDvar( "welcome_message1", "welcome_message1", "This server is running Death Run Mod", "", "", "string" );
	braxi\_dvar::addDvar( "welcome_message2", "welcome_message2", "Have fun and good luck :)", "", "", "string" );
